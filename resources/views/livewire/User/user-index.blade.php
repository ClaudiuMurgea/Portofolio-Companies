                ...
                <div class="card-body">
                    ...
                    <div class="table table-responsive pt-3">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @if( auth()->user()->hasRole('Platform Admin') || auth()->user()->hasRole('Regional Admin')) {{-- to change --}}
                                            ...
                                            <td class="no-gutters p-0 col-2">
                                                <table class="table table-borderless no-gutters">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <button wire:click="show('showEdit', {{ $user->id }})" class="btn btn-link p-0 mx-4"><i data-feather="edit-3"></i>Edit</button>
