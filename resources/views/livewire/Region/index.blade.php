                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        @if (auth()->user()->hasRole('Platform Admin'))
                            <button wire:click= 'showForm' class="btn btn-success btn-sm mb-5" > Add Region</button>
                        @else  
                                        ...
                                        <td class="no-gutters p-0 col-2">
                                            <table class="table table-borderless no-gutters">
                                                <div class="d-flex justify-content-between">                                                 
                                                    ...
                                                    @if (auth()->user()->hasRole('Platform Admin'))
                                                        <button wire:click="edit({{ $region->id }})" class="btn btn-link p-0 mx-4"><i data-feather="edit-3"></i>Edit</button>                                           
