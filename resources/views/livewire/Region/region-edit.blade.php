<div class="position-absolute start-0 w-100">
    ...
    <nav class="navbar navbar-light p-0">
        <div class="container-fluid">
          <a class="navbar-brand text-success p-0">Regions &nbsp; / &nbsp; Edit Region</a>
          <a class="navbar-brand btn btn-success text-white p-0 col-md-1 d-flex justify-content-center" href="{{ route('livewire.region') }}">
