                ...
                <div class="profile-header">
                    <div class="cover">
                        ...
                        <div class="cover-body d-flex justify-content-between align-items-center">
                            {{-- <div>
                                <img class="profile-pic" src="{{ url('storage/'.$facility->profile->media->url) }}" alt="profile">
                                <span class="profile-name">{!! $facility->name !!}</span>
                            </div> --}}
                            {{-- @if(!Auth::user()->hasRole('Facility Editor'))
                                <div class="d-none d-md-block"> --}}
                                    
                                    {{-- <a href="{{ route('company.facility.edit',[$facility->company_id,$facility]) }}" class="btn btn-primary btn-icon-text btn-edit-profile"> --}}
                                    {{-- <a href="#" class="btn btn-primary btn-icon-text btn-edit-profile">
...
{{-- 
        <div  class=" tab-content profile-body"  id="lineTabContent">
            <div class="tab-pane  fade active show" id="menu" role="tabpanel" aria-labelledby="menu-line-tab">
                 @include('facility.settings.incs.menu')
            </div>
