<div>
                                    ...
                                    <div class="col-sm-12 grid-margin stretch-card">
                                        <div class="card">
                                            ...
                                            <div class="card-header p-0 offset-1">
                                                <h5 class="text-success">{{ ucfirst($announcement->title) }}</h5>
                                            </div>

                                            <div class="card-body d-flex justify-content-between p-0">
                                                <p class="offset-1 text-success">
                                                    &emsp;&emsp;{{ ucfirst($announcement->announcement) }}
                                                </p>

                                                <button wire:click="delete({{ $announcement->id }})" class="bg-white border-white">
    ...
    @if($showEdit == true)
        <div>
            <livewire:facility.settings.announcements.announcement-edit :facility="$facilityID" />      
        </div>
    @endif
