            ...
            <div class="container-fluid">
                <a class="p-0 mb-3">
                    <span class="text-success">Facilities</span> 
                        &nbsp; / &nbsp; 
                    <span class="text-dark">Create Facility</span>
                </a>
                <a wire:click="back" class="btn btn-success text-white p-0 mb-3 col-md-1 d-flex justify-content-center" href="{{ route('livewire.facility', $ids) }}">
