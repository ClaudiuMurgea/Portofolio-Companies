@if($showIndex == true)
    <div class="position-absolute start-0 w-100">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"> <a href="#">&emsp; Facilities &emsp;</a> </li>
                <li class="breadcrumb-item active" aria-current="page">&emsp; All Facilities </li>
            </ol>
        </nav>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr class="table-success">
                                        ...
                                        <td class="text-center col-9"> Action    </td>
                                    </tr>
                                </thead>        
                                    ...
                                    @foreach ( $facilities as $facility)
                                        @if ( auth()->user()->can($facility->permissions->name) || auth()->user()->hasRole('Platform Admin||Regional Admin||Corporate Admin') )
                                            <tr class="table-success">        
                                                ...
                                                <td class="text-center col-2 pt-1 pb-0">
